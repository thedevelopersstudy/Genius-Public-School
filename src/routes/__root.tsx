...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Genius Kids and Public School · Electronic City, Bangalore" },
      {
        name: "description",
        content:
          "A premium, joyful learning environment in Electronic City — Playgroup to Primary. Admissions open for 2025–26.",
      },
      { name: "author", content: "Genius Kids and Public School" },
